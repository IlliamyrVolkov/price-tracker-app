...
class GetPriceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ParserWeb = channel.unary_unary(
                '/price.GetPrice/ParserWeb',
...
def add_GetPriceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ParserWeb': grpc.unary_unary_rpc_method_handler(
                    servicer.ParserWeb,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'price.GetPrice', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('price.GetPrice', rpc_method_handlers)
